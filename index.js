...
// - Primeiro run (headed) para login manual → salva sessão em auth.json
// - Próximos runs (headless) reutilizam a sessão e rodam em cron 00:00
// ================================================
// Requisitos: Node 18+  |  npm i
// Comandos:
//   1) npm run login   (abre o navegador para você logar e salvar sessão)
//   2) npm run dry     (simula sem clicar)
//   3) npm run sync    (executa atualização real)
// ================================================
...
GDRIVE_FOLDER_ID=xxxxxxxxxxxxxxxxxxxxxxxx
# (opcional) nome fixo
# GDRIVE_FILE_NAME=estoque_caju.xlsx

# iFood (painel)
IFOOD_LOGIN_URL=https://portal.ifood.com.br/login
IFOOD_CATALOG_URL=https://portal.ifood.com.br/catalog
...
# Regras
MAP_FILE=./map.json
DEFAULT_PRICE_FIELD=preco
DEFAULT_QTY_FIELD=quantidade
STOP_SELL_AT_ZERO=true
=============================================== */
...
----------------------------------------------------
{
  "SKU-0001": "Pão de queijo (6 unidades)",
  "SKU-0002": "Brownie Caju Zero"
}
=============================================== */

/* ================================================
XLSX esperado (exemplo)
----------------------------------------------------
sku,quantidade,preco
SKU-0001,10,14.90
SKU-0002,0,8.90

- Quando STOP_SELL_AT_ZERO=true, quantidade 0 → desliga disponibilidade
=============================================== */

/* ================================================
Crontab (00:00 diário, headless)
----------------------------------------------------
0 0 * * * TZ=America/Maceio /usr/bin/node /caminho/para/index.js >> /var/log/ifood-rpa.log 2>&1
=============================================== */
